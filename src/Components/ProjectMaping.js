...
class ProjectMaping extends Component {
    render() {
        var {gallery}= this.props;
 
 
         var element = gallery.map((Gallery, index) =>{
             return Gallery.type === 'projectMapping' ? (
             ...
             <h4 className="text-uppercase">{Gallery.name}</h4>
                           ...
                           <img className="img-fluid d-block mx-auto" style= {{width:700}}  src={Gallery.img} alt="" />
             <p>{ Gallery.content}</p>
